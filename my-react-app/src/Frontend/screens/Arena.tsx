    ...
    <div className="arena">
      ...
      <div className="arena-body">
        <section className="table">
          <div className="pot">
            <span
              className={`pot-value n${snapshot.phase === "farkle" ? " pot-lost" : ""}`}
            >
              {pot.toLocaleString()}
            </span>
          ...
          {locked.length > 0 && (
            <div className="kept">
              ...
              {locked.map((die) => (
                <Die key={die.id} die={die} size="sm" />
              ))}
          ...
          {snapshot.phase === "gameOver" && snapshot.winner && (
            <div className="overlay">
              ...
              <span className="overlay-sub">
                {snapshot.winner.banked.toLocaleString()} points
              </span>
              <button
                type="button"
